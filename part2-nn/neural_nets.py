...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        # Compute gradients
        # 1 by 1
        output_layer_error = np.multiply( activated_output - y, output_layer_activation_derivative(output)) 
        # 3 by 1
        hidden_layer_error = np.multiply((np.transpose(self.hidden_to_output_weights)*output_layer_error), vec_relu_derivative(hidden_layer_weighted_input))
