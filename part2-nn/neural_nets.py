...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        # Compute gradients
        # output_layer_error = 0.5 * np.square(y-activated_output) # TODO
        # hidden_layer_error = # TODO (3 by 1 matrix)

        bias_gradients = (y-activated_output)
        bias_gradients *= output_layer_activation_derivative(output) # TODO
        bias_gradients *= self.hidden_to_output_weights
        # hidden_to_output_weight_gradients = (activated_output-y)*output_layer_activation_derivative(output)*hidden_layer_activation # TODO
        # input_to_hidden_weight_gradients = (activated_output-y)*output_layer_activation_derivative(output)*self.hidden_to_output_weights*np.vectorize(rectified_linear_unit_derivative)(hidden_layer_weighted_input)*input # TODO
